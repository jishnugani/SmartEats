(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[2888], {
    ...
    10593: function(e, t, n) {
        ...
        function s(e, t, n) {
            return (t = (0,
            i.Z)(t))in e ? Object.defineProperty(e, t, {
                value: n,
                enumerable: !0,
                configurable: !0,
                writable: !0
        ...
        var k = ["backend", "detection"]
          , w = function(e) {
            ...
            if ("cimode" === c)
                return a;
            if ("undefined" === typeof a.fallbackLng && (a.fallbackLng = a.defaultLocale,
            "default" === a.fallbackLng)) {
                var S = h(v, 1);
                a.fallbackLng = S[0]
            }
            ...
            if (d) {
                ...
                if ("string" === typeof j)
                    a.fallbackLng = a.locales.filter((function(e) {
                        return e.includes("-")
                    }
                    )).reduce($, {
                        default: [j]
                ...
                g.Z)(j))
                    a.fallbackLng = Object.entries(a.fallbackLng).reduce((function(e, t) {
                        var n, r = h(t, 2), o = r[0], i = r[1];
                        return e[o] = o.includes("-") ? (n = [o.split("-")[0]].concat(f(i)),
                        Array.from(new Set(n))) : i,
                        e
                    }
                    ), j);
        ...
        function E(e, t, n) {
            const {obj: r, k: o} = R(e, t, Object);
            r[o] = n
        }
        function A(e, t) {
            const {obj: n, k: r} = R(e, t);
            if (n)
                return n[r]
        }
        function I(e, t, n) {
        ...
        function F(e, t, n) {
            for (const r in t)
                "__proto__" !== r && "constructor" !== r && (r in e ? "string" === typeof e[r] || e[r]instanceof String || "string" === typeof t[r] || t[r]instanceof String ? n && (e[r] = t[r]) : F(e[r], t[r], n) : e[r] = t[r]);
            return e
        }
        function T(e) {
            return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&")
        ...
        class H extends j {
            ...
            translate(e, t, n) {
                ...
                if (m && p && ("string" !== typeof p && "boolean" !== typeof p && "number" !== typeof p) && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(h) < 0 && ("string" !== typeof d || "[object Array]" !== h)) {
                ...
                } else if (m && "string" === typeof d && "[object Array]" === h)
                    p = p.join(d),
                    p && (p = this.extendTranslation(p, e, t, n));
                else {
                    let r = !1
                      , s = !1;
                    ...
                    if (s || r || y) {
                        if (this.logger.log(y ? "updateKey" : "missingKey", l, a, i, y ? d : p),
                        o) {
                        ...
                        const r = (e,n,r)=>{
                            const o = f && r !== p ? r : m;
                            this.options.missingKeyHandler ? this.options.missingKeyHandler(e, a, n, o, y, t) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(e, a, n, o, y, t),
                    ...
                    p = this.extendTranslation(p, e, t, u, n),
            ...
            resolve(e) {
                ...
                e.forEach((e=>{
                    ...
                    c.forEach((e=>{
                        ...
                        !B[`${g[0]}-${e}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(i) && (B[`${g[0]}-${e}`] = !0,
                        ...
                        g.forEach((n=>{
                            ...
                            if (this.i18nFormat && this.i18nFormat.addLookupKeys)
                                this.i18nFormat.addLookupKeys(i, l, n, e, s);
                            else {
                                let e;
                                ...
                                if (u && (i.push(l + e),
                                s.ordinal && 0 === e.indexOf(r) && i.push(l + e.replace(r, this.options.pluralSeparator)),
                                p && i.push(l + t)),
                                f) {
                                    const n = `${l}${this.options.contextSeparator}${s.context}`;
                                    i.push(n),
                                    u && (i.push(n + e),
                                    s.ordinal && 0 === e.indexOf(r) && i.push(n + e.replace(r, this.options.pluralSeparator)),
                                    p && i.push(n + t))
                                }
                            }
                            let a;
                            for (; a = i.pop(); )
                                this.isValidLookup(t) || (r = a,
                                t = this.getResource(n, e, a, s))
                        }
                        )))
                    }
                    ))
        ...
        class Q {
            constructor(e) {
                ...
                this.options.compatibilityJSON && !G.includes(this.options.compatibilityJSON) || "undefined" !== typeof Intl && Intl.PluralRules || (this.options.compatibilityJSON = "v3",
        ...
        function ee(e, t, n) {
            let r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "."
              ...
              , i = I(e, t, n);
            return !i && o && "string" === typeof n && (i = M(e, n, r),
            void 0 === i && (i = M(t, n, r))),
            i
        }
        class te {
            ...
            init() {
                ...
                this.escape = void 0 !== t.escape ? t.escape : V,
            ...
            interpolate(e, t, n, r) {
                ...
                const c = e=>{
                    ...
                    return this.format(ee(t, a, i, this.options.keySeparator, this.options.ignoreJSONStructure), s, n, {
                        ...r,
                        ...t,
                        interpolationkey: i
                    })
                ...
                return [{
                    ...
                    for (s = 0; o = t.regex.exec(e); ) {
                        ...
                        void 0 === i)
                            ...
                            "string" === typeof i || this.useRawValueToEscape || (i = $(i));
        ...
        class re {
            ...
            format(e, t, n) {
                ...
                return t.split(this.formatSeparator).reduce(((e,t)=>{
                    const {formatName: o, formatOptions: i} = function(e) {
                ...
                if (this.services.utils && this.services.utils.hasLoadedNamespace && !this.services.utils.hasLoadedNamespace(t))
                    ...
                    if (this.backend && this.backend.create) {
                        ...
                        if (c.length < 6)
                            try {
                                let o;
                                o = 5 === c.length ? c(e, t, n, r, l) : c(e, t, n, r),
                                o && "function" === typeof o.then ? o.then((e=>s(null, e))).catch(s) : s(null, o)
                            } catch (a) {
                                s(a)
                            }
                        else
        ...
        class le extends j {
            ...
            init() {
                ...
                !this.options.isClone) {
                    ...
                    this.modules.formatter ? t = this.modules.formatter : "undefined" !== typeof Intl && (t = re);
                    ...
                    i.languageUtils = n,
                    i.pluralResolver = new Q(n,{
                        prepend: this.options.pluralSeparator,
                        compatibilityJSON: this.options.compatibilityJSON,
                        simplifyPluralSuffix: this.options.simplifyPluralSuffix
                    }),
                    !t || this.options.interpolation.format && this.options.interpolation.format !== r.interpolation.format || (i.formatter = o(t),
                    i.formatter.init(i, this.options),
                    this.options.interpolation.format = i.formatter.format.bind(i.formatter)),
                    i.interpolator = new te(this.options),
                    i.utils = {
                        hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
                    },
                    i.backendConnector = new oe(o(this.modules.backend),i.resourceStore,i,this.options),
            ...
            getFixedT(e, t, n) {
                ...
                const o = function(e, t) {
                    ...
                    let u;
                    return u = i.keyPrefix && Array.isArray(e) ? e.map((e=>`${i.keyPrefix}${c}${e}`)) : i.keyPrefix ? `${i.keyPrefix}${c}${e}` : e,
                    r.t(u, i)
                };
            ...
            cloneInstance() {
                ...
                n && (o.store = new z(this.store.data,r),
                o.services.resourceStore = o.store),
                o.translator = new H(o.services,r),
        ...
        var he = function(e, t) {
          ...
          , de = function(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null
              , n = function(n) {
                var i, s, l = (n.pageProps || {})._nextI18Next, c = null !== (i = null === l || void 0 === l ? void 0 : l.initialLocale) && void 0 !== i ? i : null === n || void 0 === n || null === (s = n.router) || void 0 === s ? void 0 : s.locale, u = null === l || void 0 === l ? void 0 : l.ns, p = (0,
                a.useRef)(null), f = (0,
                a.useMemo)((function() {
                    var e;
                    if (!l && !t)
                    ...
                    if (null === n || void 0 === n || null === (e = n.i18n) || void 0 === e || !e.defaultLocale)
    ...
    78510: function(e, t, n) {
        ...
        "undefined" !== typeof navigator && (function() {
            var e, t, n = navigator.userAgent, r = n.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) || [];
            if (/trident/i.test(r[1]))
                return "IE " + ((t = /\brv[ :]+(\d+)/g.exec(n) || [])[1] || "");
            if ("Chrome" === r[1] && null != (t = n.match(/\b(OPR|Edge)\/(\d+)/)))
                return t.slice(1).join(" ").replace("OPR", "Opera");
            r = r[2] ? [r[1], r[2]] : [navigator.appName, navigator.appVersion, "-?"],
            null != (t = n.match(/version\/(\d+)/i)) && r.splice(1, 1, t[1]);
            var o = {
                browser: r[0],
                version: r[1],
                supported: !0
        ...
        t.default = (0,
        i.Jc)((function(e) {
            var t, n = e.Component, i = e.pageProps;
                ...
                114: function(e) {
                                ...
                                if (i === a - 1 || 1 === s)
                                    ...
                                    if (r.length < 2 || 2 !== o || 46 !== r.charCodeAt(r.length - 1) || 46 !== r.charCodeAt(r.length - 2))
                                        if (r.length > 2) {
                                            ...
                                            if (l !== r.length - 1) {
                                                -1 === l ? (r = "",
                                                o = 0) : o = (r = r.slice(0, l)).length - 1 - r.lastIndexOf("/"),
                                                i = a,
                                                s = 0;
                                                continue
                                            }
                    ...
                    var r = {
                        ...
                        relative: function(e, n) {
                            ...
                            for (var l = n.length - a, c = s < l ? s : l, u = -1, p = 0; p <= c; ++p) {
                                if (p === c) {
                                    if (l > c) {
                                        ...
                                        s > c && (47 === e.charCodeAt(o + p) ? u = p : 0 === p && (u = 0));
                                    break
                                }
                            ...
                            var g = "";
                            for (p = o + u + 1; p <= i; ++p)
                                p !== i && 47 !== e.charCodeAt(p) || (0 === g.length ? g += ".." : g += "/..");
                            return g.length > 0 ? g + n.slice(a + u) : (a += u,
                            47 === n.charCodeAt(a) && ++a,
                            n.slice(a))
                        },
                            ...
                            if (void 0 !== n && n.length > 0 && n.length <= e.length) {
                                ...
                                for (r = e.length - 1; r >= 0; --r) {
                                    ...
                                    if (47 === c) {
                                        ...
                                        -1 === l && (s = !1,
                                        l = r + 1),
                                        a >= 0 && (c === n.charCodeAt(a) ? -1 === --a && (i = r) : (a = -1,
                                        i = l))
                                }
                                return o === i ? i = l : -1 === i && (i = e.length),
                                e.slice(o, i)
                            }
                            for (r = e.length - 1; r >= 0; --r)
                        ...
                        parse: function(e) {
                            ...
                            for (var s = -1, a = 0, l = -1, c = !0, u = e.length - 1, p = 0; u >= r; --u)
                                if (47 !== (o = e.charCodeAt(u)))
                                    -1 === l && (c = !1,
                                    l = u + 1),
                                    46 === o ? -1 === s ? s = u : 1 !== p && (p = 1) : -1 !== s && (p = -1);
                                else if (!c) {
                                    a = u + 1;
                                    break
                                }
                            return -1 === s || -1 === l || 0 === p || 1 === p && s === l - 1 && s === a + 1 ? -1 !== l && (n.base = n.name = 0 === a && i ? e.slice(1, l) : e.slice(a, l)) : (0 === a && i ? (n.name = e.slice(1, s),
                            n.base = e.slice(1, l)) : (n.name = e.slice(a, s),
                            n.base = e.slice(a, l)),
                            n.ext = e.slice(s, l)),
    ...
    67421: function(e, t, n) {
        ...
        function O(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            const {i18n: n} = t
              , {i18n: o, defaultNS: i} = (0,
            r.useContext)(b) || {}
              , a = n || o || v();
            if (a && !a.reportNamespaces && (a.reportNamespaces = new x),
            !a) {
